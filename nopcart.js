...
function ManageCart( ) {
   ...
   if ( bDisplay )
      strOutput = "<TABLE CLASS=\"nopcart\"><TR>" +
                  "<TD CLASS=\"nopheader\" style='width:10%'><B>"+strILabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\" style='width:10%'><B>"+strDLabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\" style='width:10%'><B>"+strQLabel+"</B></TD>" +
                  "<TD CLASS=\"nopheader\" style='width:10%'><B>"+strPLabel+"</B></TD>" +
                  (DisplayShippingColumn?"<TD CLASS=\"nopheader\" style='width:10%'><B>"+strSLabel+"</B></TD>":"") +
                  "<TD CLASS=\"nopheader\" style='width:10%'><B>"+strRLabel+"</B></TD></TR>";
